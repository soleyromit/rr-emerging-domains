...
| **1. Contract/affiliation-agreement lifecycle** | **Behind, name it, fix it** | Unchanged — still ACPE's one outright Gap rating in the corpus. | "This is the smallest build that flips ACPE 3.5.b from Gap to Transfer, and we know it." |
